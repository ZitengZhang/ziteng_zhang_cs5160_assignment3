...
export default class MyPost extends React.Component {
    ...
    handleDelete(postId){
        Axios.delete(`/api/posts/delete/allPostcomment/${postId}`)
        .then(()=>{
    ...
    handleUpdate(postId){
         ...
         return window.location.href = '/posts_login/updatePost/'+postId;  
                ...
                renderedPosts.unshift(
                    <div className="post">
                        <Post_login title={post.title} context={post.context} username={post.username} time={post.time} 
                            ...
                            />
                        <button className="button1_style" onClick={()=> this.handleDelete(post.postId)}>delete</button>
                        <button className="button1_style" onClick={()=> this.handleUpdate(post.postId)}>update</button>
                    </div>
